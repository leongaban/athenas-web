...
<?php if ('open' == $post->comment_status) : ?>
		...
		<section id="comments">
			<div class="fb-like" data-send="true" data-width="450" data-show-faces="true" data-font="verdana"></div><br/><br/>

			<h3>Leave a Comment</h3><br/><br/>

			<!-- Facebook -->
			<div class="fb-comments" data-href="<?php echo the_permalink() ?>" data-width="470" data-num-posts="10"></div>
			<br/><br/><br/><br/>
			...
			<h3>Comment without Facebook</h3><br/><br/>
